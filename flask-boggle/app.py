...
def boggle_home_page():
    ...
    num_games = session.get('num_games', 1)
...
def post_score():
    ...
    brokenRecord=score>highscore
    print("true or false. new high score:", brokenRecord)
...
def new_game():
    ...
    return render_template('game-page.html', board=new_board)
